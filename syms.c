...
static char ps_head[] =
    ...
    "/bm{	M 3 copy RL neg 0 exch RL neg exch neg exch RL 0 exch RL "
    "fill}!\n"
...
static char psdgl[] =
    ...
    /* x y dacoda - Da Coda */
    "/dacoda{2 1 roll 10 add 2 1 roll dup 3 -1 roll dup 3 1 roll -23 add 4 1 "
    "roll\n"
    ...
    "	exch -7 add exch (O) 3 1 roll /Times-Bold 18 selectfont 4 add M "
    "show}!\n"
    ...
    /* x y marcato - accent */
    "/marcato{M -3 0 RM 3 7 RL 3 -7 RL -1.5 0 RL -1.8 4.2 RL -1.7 -4.2 RL "
    "fill}!\n"
    /* x y hld - fermata */
...
/* PS font glyphs */
static char psfgl[] = "/musgly{music 24 selectfont glyphshow}!\n"
                      "/brace{gsave\n"
...
void define_symbols(void) {
  ...
  fprintf(fout,
          ...
          "		}repeat\n"
          "	}ifelse}!\n",
          STEM_XOFF, STEM_YOFF, STEM_YOFF, BEAM_DEPTH, BEAM_DEPTH, BEAM_DEPTH,
          STEM_XOFF, STEM_YOFF, STEM_YOFF, BEAM_DEPTH, BEAM_DEPTH, BEAM_DEPTH);
